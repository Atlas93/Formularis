...
pantalla.grid(row=1, column=0, sticky="nsew")

marcInfoPersonal = tk.Frame(finestra, bd=2, relief="solid",bg="#7dbbfc")
marcInfoPersonal.grid(row=1, column=0, sticky="nsew", padx=10, pady=10)
...
marcOpcions.grid(row=2, column=0, sticky="nsew", padx=10, pady=10)
...
marcBotons.grid(row=3, column=0, sticky="nsew", padx=10, pady=10)
